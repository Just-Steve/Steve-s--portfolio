      ...
      <div className="bg-[url('/assets/images/contact-bg.jpg')] bg-cover bg-center bg-no-repeat w-full min-h-[80vh] md:min-h-[50vh] lg:min-h-[80vh] rounded-xl">
        <div className="flex flex-col items-center w-full min-h-[80vh] md:min-h-[50vh] lg:min-h-[80vh] justify-between gap-8 rounded-xl border border-white/10 shadow-xl  bg-black-100/30 backdrop-blur-lg">
          <div className="flex flex-col items-center justify-center text-center lg:text-left px-4 lg:px-0">
            <h2 className="font-semibold bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-white to-white text-5xl my-6">
              Let&apos;s Connect
            </h2>
            <p className="bg-clip-text text-transparent drop-shadow-2xl bg-gradient-to-b from-white/80 to-white/20 text-base text-center mx-auto max-w-2xl">
              Have a project idea, collaboration request, or just want to chat
              about tech? I&apos;d love to hear from you!
            </p>
          </div>

          <div className="py-5 lg:py-0 lg:min-h-[50vh]">
            <h2 className="font-semibold bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-white dark:to-white text-4xl my-6 md:text-center">
              Reach Me Via
            </h2>
            ...
            <div className="flex flex-col gap-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    <Link
                      ...
                      target="_blank"
                      className="flex hover:text-neutral-700 items-center gap-2"
                    >
              ...
              <div className="text-[12px] md:text-[15px] text-gray-400 flex items-center gap-2 order-1 md:order-1 p-2 lg:-8 rounded-full border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group justify-center">
