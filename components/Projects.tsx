    ...
    >
      ...
      <div className='relative z-10'>
        ...
        <div className='mb-16 text-center'>
          <Title text='See My Featured ' coverText='PROJECTS'/>
      ...
      <div className='absolute inset-0 bg-[linear-gradient(rgba(255,255,255,.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.02)_1px,transparent_1px)] bg-[size:50px_50px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,black,transparent)] pointer-events-none'></div>
    </section>
  )
}
