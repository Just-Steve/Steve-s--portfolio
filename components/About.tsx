              ...
              <div className="relative bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 lg:p-8 shadow-2xl">
                <div className="flex flex-col gap-5 text-gray-300 leading-relaxed">
                  <p className="text-lg">
                    ...
                    specializing in <span className="text-white font-semibold">Full Stack Web Development</span>. With a strong foundation in{' '}
                    <span className="text-white font-semibold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">
                      MERN Stack
                    </span>{' '}
                    (MongoDB, Express.js, React.js, Node.js) and expertise in{' '}
                    <span className="text-white font-semibold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                      Next.js
                    </span>, Tailwind CSS, and dynamic UI design, I craft intuitive, scalable, and efficient web applications.
                  </p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-2 text-center">
                      <div
                        className={`w-10 h-10 bg-gradient-to-br ${item.color} rounded-lg flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                      >
